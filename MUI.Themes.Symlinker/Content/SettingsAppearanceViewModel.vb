	...
	Public Class SettingsAppearanceViewModel
		...
		Public Sub New()
            ...
            Me.m_themes.Add(New Link() With {
                 ...
                 .Source = New Uri("/MUI.Themes.Symlinker;component/Assets/ModernUI.BingImage.xaml", UriKind.Relative)
            })
            Me.m_themes.Add(New Link() With {
                 .DisplayName = "hello kitty",
                 .Source = New Uri("/MUI.Themes.Symlinker;component/Assets/ModernUI.HelloKitty.xaml", UriKind.Relative)
            })
            Me.m_themes.Add(New Link() With {
                 .DisplayName = "love",
                 .Source = New Uri("/MUI.Themes.Symlinker;component/Assets/ModernUI.Love.xaml", UriKind.Relative)
            })
            Me.m_themes.Add(New Link() With {
                 .DisplayName = "snowflakes",
                 .Source = New Uri("/MUI.Themes.Symlinker;component/Assets/ModernUI.Snowflakes.xaml", UriKind.Relative)
            })

            ' add custom themes
            Me.m_themes.Add(New Link() With {
                 .DisplayName = "windows 8.1",
                 .Source = New Uri("/MUI.Themes.Symlinker;component/Assets/ModernUI.Windows8.1.xaml", UriKind.Relative)
            })
            Me.m_themes.Add(New Link() With {
                 .DisplayName = "metro",
                 .Source = New Uri("/MUI.Themes.Symlinker;component/Assets/ModernUI.Metro.xaml", UriKind.Relative)
            })
