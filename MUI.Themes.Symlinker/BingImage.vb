...
Public NotInheritable Class BingImage
	Private Sub New()
	End Sub
    Public Shared ReadOnly UseBingImageProperty As DependencyProperty = DependencyProperty.RegisterAttached("UseBingImage", GetType(Boolean), GetType(BingImage), New PropertyMetadata(AddressOf OnUseBingImageChanged))
